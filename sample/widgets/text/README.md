# adf-widget-texteditor

texteditor widget for the [angular-dashboard-framework](https://github.com/sdorra/angular-dashboard-framework).
...
#### Build the adf-widget-texteditor
...
```html
<script type="text/javascript" src="path/to/texteditor.min.js"></script>
```

Define a dependency for the module:

```javascript
angular.module('sample', ['adf', 'adf.widget.texteditor']);
```
